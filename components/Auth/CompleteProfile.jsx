...
export default function CompleteProfile({ navigation }) {
  ...
  return (
    <SafeAreaView className="flex-1 pb-5 bg-white">
      <View className="flex-1 px-6 auth-container">
        <View className="gap-4 mb-4">
          <Text className="text-3xl text-center font-interSemiBold">Complete Your Profile</Text>
          ...
          <View className="gap-3">
            ...
            <View style={styles.pickerWrapper}>
              <Picker selectedValue={gender} onValueChange={(itemValue) => setGender(itemValue)} style={styles.picker}>
                <Picker.Item style={{ fontSize: 18 }} label="Select Gender" value="" />
            ...
            <View style={styles.pickerWrapper}>
              <Picker selectedValue={skill} onValueChange={(itemValue) => setSkill(itemValue)} style={styles.picker}>
                <Picker.Item style={{ fontSize: 18, paddingLeft: 10 }} label="Select Skill" value="" />
                <Picker.Item style={{ fontSize: 18 }} label="Manual" value="Manual" />
                <Picker.Item style={{ fontSize: 18 }} label="Automatic" value="Automatic" />
                <Picker.Item style={{ fontSize: 18 }} label="Both" value="Manual & Automatic" />
              </Picker>
            </View>

            <View className="flex-row items-center gap-3 px-1 py-4">
